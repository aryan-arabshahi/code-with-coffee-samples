...
export default function SideBar() {
    ...
    return (
        <div id="left-panel" className="fixed left-0 top-0 bottom-0 z-10">
            <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" id="robot" x="0" y="0" viewBox="0 0 600 800" enableBackground="new 0 0 600 800" xmlSpace="preserve">
